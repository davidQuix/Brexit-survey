...
def check_age_range(number):
    if 0 <= number <= 10:
        print("Number belongs to range 0-10")
    elif 11 <= number <= 20:
        print("Number belongs to range 11-20")
    elif 21 <= number <= 30:
        print("Number belongs to range 21-30")
    else:
        print("Number doesn't belong to any specified range")
